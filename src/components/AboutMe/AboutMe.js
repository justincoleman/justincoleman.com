    ...
    return (
        <div id="about" className="about cf">
            <div className="about__text-cntr">
                ...
                <p className="about__text">As you may, or may not, have gathered my name is Justin Coleman. I'm a front-end designer based out of Philadelphia, Pennsylvania.</p>
